...
export const BottomSheet: React.FC<BottomSheetProps> = ({
  ...
  return (
    <>
      ...
      {/* Sheet */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl border-t shadow-2xl transform transition-transform duration-300 ease-out pb-[env(safe-area-inset-bottom)] ${
          styles.cardBase
        } ${styles.cardBorder} ${
