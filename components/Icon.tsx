...
const paths: Record<string, string> = {
  ...
  pinFilled:
    "M16 12V5c0-2.21-1.79-4-4-4S8 2.79 8 5v7l-2 2v2h5v6h2v-6h5v-2l-2-2z",
  // Updated PinOff to be a crossed-out pin (Slash style)
  pinOff:
    "M12 2a3 3 0 0 0-3 3v1 M2 2l20 20 M12 12v3l-2 2v2h10v-2l-2-2v-6 M15 5a3 3 0 0 0-3-3",
  ...
  cloud:
    "M17.5 19c2.485 0 4.5-2.015 4.5-4.5 0-2.3-1.75-4.2-4-4.45-.75-3-3.5-5.05-6.5-5.05-3.5 0-6.4 2.5-7 5.9-2.5.25-4.5 2.2-4.5 4.6 0 2.485 2.015 4.5 4.5 4.5h13z",
  ...
  palette:
    "M12 21a9 9 0 1 0 0-18c1.6 0 3.2.4 4.6 1.1a1 1 0 0 1 .4 1.3l-1.3 2.1a1 1 0 0 0 .1 1.1l2.2 3.3a1 1 0 0 1-.3 1.4l-1.9 1.4a1 1 0 0 0-.4.8v.1A5.02 5.02 0 0 1 12 21z",
  ...
  incognito:
    "M20.5 10H17V9a1 1 0 0 0-1-1h-1.6a3 3 0 0 0-4.8 0H8a1 1 0 0 0-1 1v1H3.5a1.5 1.5 0 0 0 0 3h.14a4 4 0 0 0 7.72 0h1.28a4 4 0 0 0 7.72 0h.14a1.5 1.5 0 0 0 0-3zm-13 4a2 2 0 1 1 2-2 2 2 0 0 1-2 2zm9 0a2 2 0 1 1 2-2 2 2 0 0 1-2 2z",
  fileText:
  ...
  // Added Checklist
  checklist:
    "M9 5H21M9 12H21M9 19H21M3 5L5 7L8 4M3 12L5 14L8 11M3 19L5 21L8 18",
  // Heading Icons
