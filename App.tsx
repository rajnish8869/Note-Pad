...
const MainApp = () => {
  ...
  const {
    ...
    unlockApp,
    lockApp,
    setupComplete: setupGlobalSecurity,
    hasSecuritySetup,
    sessionKey,
  } = useSecurity();
  ...
  const [securitySetupMode, setSecuritySetupMode] = useState<
    "GLOBAL" | "CUSTOM"
  >("GLOBAL");
  ...
  const handleCreateNote = () => {
    const newNote: Note = {
      ...
      tags: [],
      folderId:
        view === "FOLDER" && currentFolderId ? currentFolderId : undefined,
    };
    addNote(newNote);
      ...
      {!isAppLocked && showAuthModal && (
        <div className="fixed inset-0 z-[100]">
          <AuthModal
            ...
            customSecurity={
              pendingAuthNote?.lockMode === "CUSTOM"
                ? pendingAuthNote.security
                : undefined
            }
            theme={theme}
          />
