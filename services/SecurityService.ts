...
export class SecurityService {
  ...
  private static bufToStr(buf: ArrayBuffer): string {
   ...
   */
  static async createVerifier(password: string): Promise<{ salt: string, verifier: string }> {
   ...
   */
  static async verifyPassword(password: string, storedSalt: string, storedVerifier: string): Promise<CryptoKey | null> {
    try {
